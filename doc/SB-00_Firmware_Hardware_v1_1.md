...
| Power Layer        | 18650 x2 parallel          | → TP4056 (charge) + DW01 (protect)                                    | 6,800 mAh, pass target ≥ 12 วัน @ 5 นาที |
...
| 18650 Li-ion x2 (parallel) | 6,800 mAh | ≥12 วัน (stretch 14-16 วัน) ★ | 300 THB |
...
> **หมายเหตุ:** แนะนำ: 18650 x2 parallel — เกณฑ์ผ่านขั้นต่ำของโปรเจ็กต์คือ runtime ≥ 12 วัน @ 5 นาที และมี stretch goal 14-16 วัน หลัง optimize PSM, ชาร์จผ่าน USB-C (TP4056), มี fuel gauge (MAX17048) แจ้งระดับแบตผ่าน dashboard
