...
> **Baseline decision:** `L76K` เป็น GPS default ทั้ง prototype และ production ส่วน `NEO-M8N` เป็น fallback เฉพาะกรณี field test ชี้ว่า geofence accuracy ของ L76K ยังไม่พอ
...
- ผู้ใช้เปิด AquaSense PWA / web provisioning page บนมือถือ แล้ว scan BLE พบ device
