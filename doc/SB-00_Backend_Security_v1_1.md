...
| LINE Messaging API | 200 msg/mo             | ≥ 40 devices            | Paid plan — verify current pricing before commercial launch |
...
| ------------------ | ----------------------------------------- | ---------------------------- |
| LINE Messaging API | ส่ง push message ไป LINE OA ของ AquaSense | free tier ก่อน / paid plan ตรวจราคาอีกครั้งก่อน commercial launch |
