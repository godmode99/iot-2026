...
| Deliver         | ส่งผ่าน `QR + Web/PWA` flow หลักหรือ flash ตอนผลิตด้วย USB/QC tool เท่านั้น — ห้ามส่งผ่าน HTTP plaintext |
...
- ในรอบ MVP/pilot ให้ support customer provisioning เพียง `QR + Web/PWA` flow เดียว; USB/QC fallback ใช้ภายในทีมเท่านั้น
