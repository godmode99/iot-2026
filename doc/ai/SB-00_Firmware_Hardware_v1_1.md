...
> **Support matrix (locked for pilot):**
>
> - primary baseline: `Android Chrome + HTTPS`
> - `iPhone/iPad` และ browser/device ที่ไม่มี Web Bluetooth ใช้ `QR Code + Web/PWA` หรือ `factory USB / QC tool` แทน
> - browser อื่นที่เป็น Chromium-based จะยังไม่ถือเป็น baseline จนกว่าจะทดสอบจริงแล้วผ่าน onboarding checklist
